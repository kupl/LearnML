...
let rec zip l x = match l with [] -> [] | h :: t -> (h, x) :: zip t x
...
let _ = diff (Sum [ Times [ Var "x"; Const 2 ]; Const 2 ], "x")
...
let _ = diff (Times [ Const 2; Sum [ Const 2; Var "x" ]; Const 2 ], "x")

let _ = diff (Times [ Const 2; Sum [ Const 2; Var "x" ]; Var "y" ], "x")
...
let _ = diff (Sum [ Var "y"; Const 2 ], "x")

let _ = diff (Sum [ Var "y"; Const 2; Times [ Power ("y", 2); Const 2 ] ], "x")

let _ = diff (Sum [ Var "y"; Const 2; Times [ Power ("y", 2); Const 2 ] ], "y")
