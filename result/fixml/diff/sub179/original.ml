...
let _ = diff (Sum [ Const 2; Times [ Const 2; Var "x"; Var "y" ] ], "x")

let _ = diff (Power ("x", 4), "x")

let _ = diff (Sum [ Power ("x", 2); Times [ Const 2; Var "x" ]; Const 1 ], "x")

let _ = diff (Sum [ Power ("x", 4); Times [ Const 2; Var "x" ]; Const 1 ], "x")
