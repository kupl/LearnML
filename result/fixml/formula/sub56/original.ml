...
let andAlso : bool * bool -> bool =
 fun f -> match f with true, true -> true | _ -> false


let orElse : bool * bool -> bool =
 fun f -> match f with false, false -> false | _ -> true


let imply : bool * bool -> bool =
 fun f -> match f with frue, false -> false | _ -> true
...
let equal : exp * exp -> bool =
 fun f -> match f with a, b -> if ca a = ca b then true else false
