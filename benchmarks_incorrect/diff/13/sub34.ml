...
let rec r_minimize aexp = 
	if aexp = (minimize aexp) then aexp
	else r_minimize (minimize aexp)

let diff (aexp, str) = r_minimize (r_diff (aexp, str))
