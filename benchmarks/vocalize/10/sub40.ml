...
let rec vocalize s =
	...
	else if ((sub_vocalize s 0 (n/2)) = []) && ((sub_vocalize s (n/2) (n - (n/2))) = []) then [["영"];["영"]]



	else if ((sub_vocalize s 0 (n/2)) = []) && ((sub_vocalize s (n/2) (n - (n/2))) != []) then [["영"];(sub_vocalize s (n/2) (n- n/2))]
	else if ((sub_vocalize s 0 (n/2)) != []) &&((sub_vocalize s (n/2) (n - (n/2))) = []) then [(sub_vocalize s 0 (n/2)) ; ["영"]]
