...
let checker(  ( a : crazy2 ), ( b : crazy2 ) ) =
	print_int ( crazy2val( a ) ); print_string "   "; print_int ( crazy2val( b ) ); print_string "   ";print_int ( crazy2val( crazy2add( a, b ) ) ); print_string "   ";
	if( ( crazy2val( a ) + crazy2val( b ) = crazy2val( crazy2add( a, b ) ) ) = true ) then
		print_string "correct!\n"
	else
		print_string "wrong!\n";;

checker( ZERO( NIL ), ONE( ZERO( MONE( NIL ) ) ) );;
checker( ONE( MONE( ONE ( MONE ( NIL ) ) ) ), MONE( ZERO( ONE( NIL ) ) ) );;
checker( ONE( MONE( ONE ( MONE ( NIL ) ) ) ), MONE( ONE( MONE ( ONE ( NIL ) ) ) ) );;
*)