...
and num_galculator allow_X num exp =
  ...
  | SIGMA (a, b, e) -> (sigma (int_of_float (num_galculator false num a)) (int_of_float (num_galculator false num b)) e)
  | INTEGRAL (a, b, e) -> 
    if a < b then (integral (num_galculator false num a) (num_galculator false num b) e)
	else (-1. *. (integral (num_galculator false num b) (num_galculator false num a) e))
