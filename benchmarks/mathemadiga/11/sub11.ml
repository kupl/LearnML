...
let rec mathemadiga exp = 
        ...
        |ADD (_, X) -> raise(Invalid_argument"ADD")
        |ADD (X, _) -> raise(Invalid_argument"ADD")
        ...
        |SUB (_, X) -> raise(Invalid_argument"SUB")
        |SUB (X, _) -> raise(Invalid_argument"SUB")
        ...
        |MUL (_, X) -> raise(Invalid_argument"MUL")
        |MUL (X, _) -> raise(Invalid_argument"MUL")
        ...
        |DIV (_, X) -> raise(Invalid_argument"DIV")
        |DIV (X, _) -> raise(Invalid_argument"DIV")
...
(**)
         ...
         |SIGMA(X, _, _) |SIGMA(_, X, _) -> raise(Invalid_argument"SIGMA")
         ...
         |INTEGRAL(X, _, _) |INTEGRAL(_, X, _) -> raise(Invalid_argument"INTEGRAL")
