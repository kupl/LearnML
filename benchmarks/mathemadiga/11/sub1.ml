...
let rec evalEq e arg = 
	...
	| SIGMA (e1, e2, e3) -> mathemadiga (SIGMA (e1, e2, e3)) 
	(* I didn't handle the case when there are X terms in e1, e2 
	 for double integral. I don't think it's correct grammar *)
	| INTEGRAL (e1, e2, e3) -> mathemadiga (INTEGRAL (e1, e2, e3))
