...
let opt_vector2 = ref false
let opt_vector3 = ref false
...
let options =
  [
    ...
    ("-vector", Arg.Set opt_vector, " program level, frequency vector based repair");
    ("-vector2", Arg.Set opt_vector2, " function level, frequency vector based repair");
    ("-vector3", Arg.Set opt_vector3, " function level, tree height vector based repair");
